...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Embed ZEROX audit metadata into a Paperclip jar")
...
def main() -> None:
    ...
    with tempfile.NamedTemporaryFile(prefix="zerox-paper-", suffix=".jar", delete=False, dir=jar.parent) as temporary:
